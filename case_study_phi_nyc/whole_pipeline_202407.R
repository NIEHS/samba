...
#args <- c("9", "2024-07-01 00:00:00", "2024-07-31 23:00:00", FALSE, FALSE, FALSE)
...
if (!dir.exists(paste0("./output/model", args[1], "_202407"))) {
  dir.create(paste0("./output/model", args[1], "_202407"))
}
if (!dir.exists(paste0("./graphs/model", args[1], "_202407"))) {
  dir.create(paste0("./graphs/model", args[1], "_202407"))
}
if (!dir.exists(paste0("./graphs/model", args[1], "_202407", "/evaluation"))) {
  dir.create(paste0("./graphs/model", args[1], "_202407", "/evaluation"))
}
if (!dir.exists(paste0("./graphs/model", args[1], "_202407", "/interpretation"))) {
  dir.create(paste0("./graphs/model", args[1], "_202407", "/interpretation"))
}
if (!dir.exists(paste0("./graphs/model", args[1], "_202407", "/maps"))) {
  dir.create(paste0("./graphs/model", args[1], "_202407", "/maps"))
}
...
config <- list(
  ...
  in_path = "./input/",
  out_path = paste0("./output/model", args[1], "_202407", "/"),
  graphs_path = paste0("./graphs/model", args[1], "_202407", "/")
)
