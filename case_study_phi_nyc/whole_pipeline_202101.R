...
# args[2] = ts in UTC, eg: "2023-07-01 00:00:00"
# args[3] = te in UTC, eg: "2023-07-31 23:00:00"
# args[4] = boolean for model saving as rds
# args[5] = boolean for saving all maps + analysis graphs
# args[6] = boolean for evaluation
#args <- c("9", "2021-01-01 00:00:00", "2021-01-31 23:00:00", FALSE, FALSE, FALSE)
...
if (!dir.exists(paste0("./output/model", args[1], "_202101"))) {
  dir.create(paste0("./output/model", args[1], "_202101"))
}
if (!dir.exists(paste0("./graphs/model", args[1], "_202101"))) {
  dir.create(paste0("./graphs/model", args[1], "_202101"))
}
if (!dir.exists(paste0("./graphs/model", args[1], "_202101", "/evaluation"))) {
  dir.create(paste0("./graphs/model", args[1], "_202101", "/evaluation"))
}
if (!dir.exists(paste0("./graphs/model", args[1], "_202101", "/interpretation"))) {
  dir.create(paste0("./graphs/model", args[1], "_202101", "/interpretation"))
}
if (!dir.exists(paste0("./graphs/model", args[1], "_202101", "/maps"))) {
  dir.create(paste0("./graphs/model", args[1], "_202101", "/maps"))
}
...
config <- list(
  ...
  in_path = "./input/",
  out_path = paste0("./output/model", args[1], "_202101", "/"),
  graphs_path = paste0("./graphs/model", args[1], "_202101", "/")
)
...
# open data
source("open_phi_nyc_202101.R")
input <- open_phi_nyc(cws = TRUE, pred = TRUE, ref_network = TRUE)
cws <- input$cws
...
if (save_eval == TRUE) {
  cat("Save evaluation... \n")
  source("open_mesonet.R")
  ref <- open_mesonet("202101")
