...
obs <- readRDS(
  paste0(
    "./input/cws/wu_cleaned_and_calibrated_with_econet_",
    "2021-07-01_2021-08-01.rds"
  )
)$obs |>
...
for (i in seq_along(cells)) {
  pred_list[[i]] <- readRDS(
    paste0("./input/grid_", cells[i], "_with_covar_202107.rds")
  )
}
...
saveRDS(pred,
  file = "./input/grid_full_with_covar_202107.rds"
)
write.csv(pred,
  file = "./input/grid_full_with_covar_202107.csv"
 )
