...
obs <- readRDS(
  paste0(
    "./input/cws/wu_cleaned_and_calibrated_with_azmet_",
    "2023-07-01_2023-08-01.rds"
  )
)$obs |>
...
pts_era5 <- extract_era5(
    ...
    te = as.POSIXct("2023-07-31 23:00:00", tz = "UTC")
  )
pts_covar <- merge(
...
# Save final dataset
saveRDS(cws_covar, "./input/cws/cws_covar_2023-07.rds")
write.csv(cws_covar, "./input/cws/cws_covar_2023-07.csv")
